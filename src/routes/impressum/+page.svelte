...
<div lang="de-DE" class="container">
  <h2>Angaben gemäß §5 TMG:</h2>
  <h2>Xin Liu</h2>

  <div>
    <h5>Postanschrift:</h5>
    <p>Rüttersweg 97<br />53332 Bornheim</p>
  </div>

  <div>
    <h5>Kontakt:</h5>
    <p>E-Mail: info@webmungo.com</p>
  </div>
  ...
  <div>
    <p>
      ...
      <a
        href="https://www.activemind.de/datenschutz/generatoren/impressum/"
        target="_blank"
        rel="noreferrer noopener"
        aria-label=" (öffnet in neuem Tab)">activeMind AG</a
      >
      erstellt.
    </p>
  </div>
